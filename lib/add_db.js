...
async function department() {
  return inquirer
    ...
    .then((data) => {
      ...
      db.query(`INSERT INTO departments (deptartment_name) VALUES ('${data.department}');`, function (err, results) {
        // console.log(results);
      });
...
async function employee() {
  return inquirer
    ...
    .then((data) => {
      ...
      db.query(`INSERT INTO employees (first_name, last_name, role_id, manager_id) VALUES ('${data.employee_fname}', '${data.employee_lname}', ${data.employee_role}, ${data.employee_manager});`, function (err, results) {
        // console.log(results);
      });
