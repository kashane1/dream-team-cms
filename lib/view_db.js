...
async function roles() {
  ...
  db.query('SELECT * FROM roles JOIN departments WHERE roles.department_id = departments.id;', function (err, results) {
    console.log('');
    return console.table(results);
  });
}
...
async function employees() {
  ...
  db.query('SELECT * FROM employees JOIN roles WHERE employees.role_id = roles.id', function (err, results) {
    // console.log(results);
    console.log('');
    return console.table(results);
  });
